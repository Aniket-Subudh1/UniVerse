...
<div class="container">
    ...
    <div class="dashboard-sections">
        <div class="card">
            ...
            <h3>Upload Teachers Timetable</h3>
            <p>Upload the latest timetable for teachers.</p>
            <form action="uploadTeachersTimetable" method="post" enctype="multipart/form-data">
                <input type="file" name="teachersTimetable" accept=".xls, .xlsx" required>
        ...
        <div class="card">
            ...
            <p>View the uploaded timetable for teachers.</p>
